...
const CouponCard = ({ text, isOpen, onClick, isHidden }) => {
  ...
  return (
    <button
      type="button"
      className="w-full h-40 cursor-pointer group rounded-xl focus:outline-none focus-visible:ring-4 focus-visible:ring-rose-400"
      style={{ perspective: '1000px' }}
      onClick={onClick}
      aria-expanded={isOpen}
      aria-label={isOpen ? "Close coupon" : "Open coupon"}
    >
      <div
        ...
        <div className="flex flex-col items-center gap-8 max-w-lg w-full relative z-10 transition-all duration-500 ease-in-out">
          ...
          <div className="flex flex-col md:flex-row items-center gap-6 mt-4 w-full justify-center relative min-h-[100px]">
            ...
            <button
              ...
              onFocus={handleNoHover} // For keyboard accessibility
              style={noBtnStyle}
