...
const CouponCard = ({ text, isOpen, onClick, isHidden }) => {
  ...
  return (
    <button
      type="button"
      className="w-full h-40 cursor-pointer group focus:outline-none focus-visible:ring-4 focus-visible:ring-rose-500 focus-visible:ring-offset-4 focus-visible:ring-offset-rose-50 rounded-xl"
