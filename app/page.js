...
const CouponCard = ({ text, isOpen, onClick, isHidden }) => {
  ...
  return (
    <div
      ...
      className="w-full h-40 cursor-pointer group focus-visible:outline-none focus-visible:ring-4 focus-visible:ring-rose-400 focus-visible:ring-offset-2 focus-visible:rounded-xl"
